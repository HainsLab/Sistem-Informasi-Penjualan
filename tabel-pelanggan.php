...
<html lang="en">
  ...
  <div class="judul">
        ...
        <a href='form-penjualan.php'>Tambah Data Pelanggan</a>
        <div class="table-container">
          <table border=1>
            ...
            while ($r = mysqli_fetch_array($ex)) {
                echo "<tr>";
                echo "<td>" . $r['id_pelanggan'] . "</td>";
                echo "<td>" . $r['nm_pelaggan'] . "</td>";
                echo "<td>" . $r['alamat'] . "</td>";
                echo "<td>" . $r['no_tlp'] . "</td>";
                echo "<td>
                    <a href='ubah-form-pelanggan.php?n=" . $r['id_pelanggan'] . "'>
                    <i class='bx bxs-edit-alt'></i>
                    <span>ubah</span>
                    </a>
                    <a href='delete-form-pelanggan.php?n=" . $r['id_pelanggan'] . "'>
